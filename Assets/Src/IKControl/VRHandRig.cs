...
namespace IKControl {
    public class VRHandRig : MonoBehaviour {
        ...
        [SerializeField]
        private HandRigSetup leftHand;

        [SerializeField]
        private HandRigSetup rightHand;
        ...
        [SerializeField]
        private int waitFrames = 2; // XROrigin移動を待つフレーム数

        [Header("Tracking Mode")]
        [SerializeField]
        private TrackingMode trackingMode = TrackingMode.Direct;
